...
for iter in range(5):
    ...
    print("KNN -1")
    print(accuracy_score(Y_test, preds))
    acclistknn1.append(accuracy_score(Y_test, preds))
    f1listknn1.append(f1_score(Y_test, preds, average="macro"))
    ...
    print("KNN -2")
    print(accuracy_score(Y_test, preds))
    acclistknn2.append(accuracy_score(Y_test, preds))
    f1listknn2.append(f1_score(Y_test, preds, average="macro"))
...
acclistknn1 = np.array(acclistknn1)
f1listknn1 = np.array(f1listknn1)
print("knn-1")
print(np.mean(acclistknn1), np.mean(f1listknn1))

acclistknn2 = np.array(acclistknn2)
f1listknn2 = np.array(f1listknn2)
print("knn-2")
print(np.mean(acclistknn2), np.mean(f1listknn2))
